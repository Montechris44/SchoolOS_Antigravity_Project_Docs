...
export default function ActionCenterPage() {
  ...
  const refreshActions = () => {
    if (!school) return;
    setActions(db.getActions(securityCtx));
  };
  ...
  const handleUpdateStatus = (actionId: string, status: ActionStatus, outcome?: string) => {
    db.updateActionStatus(securityCtx, actionId, status, outcome);
    refreshActions();
  ...
  const handleResolveSubmit = (e: React.FormEvent) => {
    ...
    handleUpdateStatus(selectedActionToResolve.id, "RESOLVED", resolutionOutcome);
