...
import { SYSTEM_TEMPLATES, messagingService } from "@/modules/communication/messaging-service";
...
export default function CommunicationPage() {
  ...
  const refreshAnnouncements = () => {
    if (!school) return;
    setAnnouncements(db.getAnnouncements(securityCtx));
  };
  ...
  const handleSendAnnouncement = async (e: React.FormEvent) => {
    ...
    await messagingService.dispatchAnnouncement(securityCtx, {
      title,
      body,
      channels,
